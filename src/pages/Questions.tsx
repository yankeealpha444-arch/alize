...
export default function Questions() {
  ...
  const projectName = idea.split(" ").slice(0, 5).join(" ") || "Untitled";
  ...
  return (
    <div className="max-w-xl mx-auto px-4 pt-6 pb-16">
      ...
      <div className="mb-8">
        ...
        <h2 className="text-lg font-medium text-foreground truncate mb-4">{projectName}</h2>
      ...
      <div className="bg-card border border-border rounded-xl p-5 mb-8">
        ...
        <p className="text-[10px] text-muted-foreground mb-4">This decides whether we include pricing/pre-order in the MVP.</p>
