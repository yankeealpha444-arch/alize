...
function getActionRoute(action: string, projectId: string): string {
  ...
  if (lower.includes("signup") || lower.includes("onboarding") || lower.includes("activation")) return `/tests/${projectId}`;
  if (lower.includes("pricing") || lower.includes("conversion")) return `/tests/${projectId}`;
  if (lower.includes("retention") || lower.includes("product")) return `/tests/${projectId}`;
...
function getActionLabel(action: string): string {
  ...
  if (lower.includes("crushing")) return "View Results";
  return "Run Test";
}
