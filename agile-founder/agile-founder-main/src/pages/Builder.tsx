    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-card shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={handleCopyLink} className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground px-3 py-1.5 rounded-lg border border-border hover:bg-secondary transition-colors">
            <Copy className="h-3.5 w-3.5" /> Copy Public Link
          </button>
          <button onClick={() => window.open(`/p/${projectId}`, "_blank")} className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground px-3 py-1.5 rounded-lg border border-border hover:bg-secondary transition-colors">
            Preview MVP
          </button>
        </div>
      </div>
          ...
          <div className="flex-1 overflow-y-auto bg-background flex justify-center p-4">
            {activeSection === "edit" ? (
              ...
              <div className="flex gap-4 w-full max-w-5xl">
                ...
                >
                  <SaaSPreview projectName={projectName} activeSection="mvp" includePricing={includePricing} />
                </div>
              </div>
            ) : (
              <div
              ...
              >
                {activeSection === "mvp" && <SaaSPreview projectName={projectName} activeSection={activeSection} includePricing={includePricing} />}
